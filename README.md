# Generalized Geometric Langlands — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/generalized-geometric-langlands-canonical-lane-mathlib.git
cd generalized-geometric-langlands-canonical-lane-mathlib
lake exe
lake build
```
