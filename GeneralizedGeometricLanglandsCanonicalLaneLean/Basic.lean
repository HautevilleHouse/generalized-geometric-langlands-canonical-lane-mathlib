/-!
# generalized-geometric-langlands-canonical-lane Lean migration boundary
...
`GeneralizedGeometricLanglandsCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "generalized-geometric-langlands-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/generalized-geometric-langlands-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for Generalized geometric Langlands: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["generalized-geometric-langlands", "representation-theory", "algebraic-geometry", "sheaf-theory", "moduli-stacks", "mathematical-proof", "reproducibility", "canonical-lane", "local-to-global", "manifold-constrained"]
