...
/-!
# Source dependency model for `generalized-geometric-langlands-canonical-lane`
...
def sourcePathDependencies : List SourcePathDependency := [
  ...
  { file := "scripts/ggl_closure_guard.py", name := "DEFAULT_REGISTRY", path := "artifacts/constants_registry.json", role := "artifact", line := 14 },
  { file := "scripts/ggl_closure_guard.py", name := "DEFAULT_STITCH", path := "artifacts/stitch_constants.json", role := "artifact", line := 15 },
  { file := "scripts/ggl_closure_guard.py", name := "DEFAULT_OUT", path := "repro/certificate_runtime.json", role := "repro", line := 16 },
  { file := "scripts/ggl_closure_guard.py", name := "DEFAULT_HISTORY", path := "repro/drift_guard_runs.jsonl", role := "repro", line := 17 },
